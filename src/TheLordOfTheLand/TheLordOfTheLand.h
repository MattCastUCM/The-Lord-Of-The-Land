...
/**
* @brief Establece los valores de la logica
* @param width Ancho de la logica
* @param height Alto de la logica
*/
JUEGO_API void getLogicSize(uint32_t& width, uint32_t& height);
/**
